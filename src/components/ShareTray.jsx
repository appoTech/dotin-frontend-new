...
import ShareButtons from "./share/ShareAction";
import RewardsList from "./share/RewardsList";
import LevelProgress from "./share/LevelProgress";
import { Button } from "./ui/button";
import StoryModal from "./StoryModal.jsx";
import "../css/shareTray.css";

const challenges = [
  { shares: 0, title: "Bronze Sharer", icon: Trophy, Description: "Comment your name in chat box", reward: "Follow" },
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[95vh] overflow-y-auto">
        <div className="share-tray-banner-container">
          <img
            src="/portal.png"
            alt="ShareTray banner"
            className="share-tray-banner-img"
          />
        </div>
        <DialogHeader>
          <DialogTitle>
            <Trophy style={{ width: '20px', height: '20px', color: '#facc15', marginRight: '8px' }} className="animate-bounce" />
            Share & Earn Rewards
        ...
        <div className="share-tray-content-wrapper">
